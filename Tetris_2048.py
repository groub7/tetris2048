from StdDraw import stddraw, stdaudio # the stddraw module is used as a basic graphics library
...
PATH = "C:/Users/Fellandes/Downloads/y2mate.com - Tetris 99  Main Theme.wav"
def start():
